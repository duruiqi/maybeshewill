...
<style type="text/css">
  ...
  <span style="color:font-size:16px;"><a href="#">　首页　</a>&gt;<a href="#">在线地图</a></span>
  <div style="width:697px;height:550px;border:#ccc solid 1px;margin:20px 0px 0px 40px;" id="dituContent"></div>
...
<script type="text/javascript">
    ...
    function createMap(){
        ...
        var point = new BMap.Point(103.91377,30.618287);//定义一个中心点坐标
...
/*     	var geolocation = new BMap.Geolocation();
    ...
    //标注点数组${requestScope.onlineMap.markerContent}
